...
public class AdminSignUpPage extends AppCompatActivity {
    ...
    LinearLayout gotoAdminLoginButton;
    ProgressBar spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.progress_loader_progressbar);
        spinner.setVisibility(View.GONE);

        gotoAdminLoginButton = findViewById(R.id.gotoAdminLoginButton);
        //SEX DROPDOWN
        ...
        birthdayInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AdminSignUpPage.this,
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) || !isValidEmail(email)) {
                    Toast.makeText(AdminSignUpPage.this, "Enter a valid email address", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(password)) {
                    Toast.makeText(AdminSignUpPage.this, "Enter password", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (!password.equals(confirmPassword)) {
                    Toast.makeText(AdminSignUpPage.this, "Passwords do not match", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (password.length() < 8) {
                    Toast.makeText(AdminSignUpPage.this, "Password should be at least 8 characters long", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(firstName)) {
                    Toast.makeText(AdminSignUpPage.this, "Please input first name", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(lastName)) {
                    Toast.makeText(AdminSignUpPage.this, "Please input last name", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(contactNum)) {
                    Toast.makeText(AdminSignUpPage.this, "Please input contact number", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(address)) {
                    Toast.makeText(AdminSignUpPage.this, "Please input address", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(birthdate)) {
                    Toast.makeText(AdminSignUpPage.this, "Please input birthday", Toast.LENGTH_SHORT).show();
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                DatabaseReference userRef = mDatabase.child("AdminUserData").child(userId);
                                                ...
                                                Toast.makeText(AdminSignUpPage.this, "User registered successfully. Please verify your email and contact Cloud Admin to register you as Admin.",
                                                ...
                                                Toast.makeText(AdminSignUpPage.this, "Authentication failed. Please try again or contact admin",
                                                        Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                    ...
                                    Log.w(TAG, "createUserWithEmail:failure", task.getException());
                                    Toast.makeText(AdminSignUpPage.this, task.getException().getMessage(),
                                            Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
