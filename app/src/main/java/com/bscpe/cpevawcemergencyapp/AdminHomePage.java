...
import com.bscpe.cpevawcemergencyapp.databinding.ActivityAdminHomePageBinding;
...
public class AdminHomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmLogout.setOnClickListener(v -> {
            ...
            // go to LandingPage
            Intent intent = new Intent(AdminHomePage.this, LandingPage.class);
            startActivity(intent);
            finish();
            Toast.makeText(AdminHomePage.this, "Successfully Logged Out", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
        });
    ...
    private void fetchAndDisplayUserData() {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference().child("AdminUserData").child(userId);
            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    AdminHomeFragment homeFragment = AdminHomeFragment.newInstance(firstName);
